package cn.edu.nju.cs.itrace4.exp.jhotdraw.icsme;
 ...
 */
public class JHotDraw_JS_ICSME {

    public static void run() throws IOException, ClassNotFoundException {
        TextDataset textDataset = new TextDataset(JHotDraw_CONSTANTS.ucPath, JHotDraw_CONSTANTS.classDirPath, JHotDraw_CONSTANTS.rtmClassPath);
        ...
        Result result_o = IR.compute(textDataset, IRModelConst.JSD, new O_CSTI(class_relation));
        Result result_pagerank = IR.compute(textDataset, IRModelConst.JSD, new PageRank_CSTI(class_relation));
        ...
        Result result_pruningeCall_Data_Dir = IR.compute(textDataset, IRModelConst.JSD, new PruningCall_Data_Connection_Closenss(class_relation, class_relationForO, class_relationForAllDependencies,UseEdge.Call, 1.0, 1.0));
        ...
        System.out.println("------------------------------");
        System.out.println("result_pruningeCall_Data_Dir JHotDraw JS");
...
//        curve.resultStore(JHotDraw_CONSTANTS.jsExpExportPath_ICSME, "call_0.7_data_0.9_idtf_1.4");
