...
public class iTrust_LSI_ICSME {
    ...
    public static void run() throws IOException, ClassNotFoundException {
        ...
        System.out.println("------------------------------");
        System.out.println("result_pruningeCall_Data_Dir iTrust_LSI");
        ...
        curve.showChart();
//        curve.resultStore(ITRUST_CONSTANTS.lsiExpExportPath_ICSME, "call_0.7_data_0.9_idtf_1.4");
//        curve.curveStore("");
    }
