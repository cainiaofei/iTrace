 ...
 */
public class UD_CSTI implements CSTI {

    public double bonus;
    private RelationGraph relationGraph;

    public UD_CSTI(RelationInfo relationInfo) {
...
//        System.out.println(" resultLinks = " + resultLinks );
        ...
        Set<String> set = matrix.targetArtifactsIds();
        for (SingleLink link : resultLinks) {
        	/**
        	 * 2017/6/11 add some code used to exclude useless class. 
        	 */
        	if(set.contains(link.getTargetArtifactId())){
...
//        System.out.println(" matrix_ud = " + matrix_ud );
        matrix_ud.allLinks();
//        for(SingleLink singleLink:matrix_ud.allLinks()){
