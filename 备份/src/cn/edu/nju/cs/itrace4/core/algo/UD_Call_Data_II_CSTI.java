 ...
 */
public class UD_Call_Data_II_CSTI implements CSTI {
    ...
    public UD_Call_Data_II_CSTI(RelationInfo relationInfo, UseEdge useEdge) {
    ...
    public SimilarityMatrix improve(SimilarityMatrix matrix, TextDataset textDataset, SimilarityMatrix similarityMatrix) {
        ...
        while (originLinks.size() != 0) {
            ...
            if (oracle.isLinkAboveThreshold(source, target) && !improvedLinks.contains(source + "#" + target)) {
                ...
                ((CallDataRelationGraph) relationGraph).searhNeighbourConnectedGraphByData(relationGraph.getCodeVertexByName(target), connectedVertexByData);
