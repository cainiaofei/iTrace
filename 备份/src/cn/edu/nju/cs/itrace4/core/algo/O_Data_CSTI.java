 ...
 */
public class O_Data_CSTI implements CSTI {

    private double bonus;
    private RelationGraph relationGraph;

    public O_Data_CSTI(RelationInfo relationInfo) {
...
//                List<CodeVertex> neighbours = ((CallDataRelationGraph) relationGraph).getNeighboursByCall(target);
                List<CodeVertex> neighbours = ((CallDataRelationGraph) relationGraph).getNeighboursByData(target);
