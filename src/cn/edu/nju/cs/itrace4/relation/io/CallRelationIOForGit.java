 ...
 * @author zzf 
 * @date 2017/10/19
 * @description used to read git project database. The format of database is: *source*、 *edgeData*、*sink* 
 */
public class CallRelationIOForGit implements CallRelationIOInterface{
...
//        String callDBPath = "data/exp/iTrust/relation/call.db";
        ...
        CallRelationList callRelationList = CallRelationIOForGit.parser(callDBPath);
    }
}
