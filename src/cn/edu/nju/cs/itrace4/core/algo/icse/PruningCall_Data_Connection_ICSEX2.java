 ...
 */
public class PruningCall_Data_Connection_ICSEX2 implements CSTI {
    ...
    public PruningCall_Data_Connection_ICSEX2(RelationInfo prunedRelationInfo, RelationInfo fullRelationInfo, UseEdge useEdge, Double bonus_thresholdForCall, Double bonus_thresholdForData) {
...
//                        System.out.println(" bonusValue = " + bonusValue);
                        ...
                        if (score < maxBonusedValue) {
                            ...
                            double afterBonus = score * (1 + 2 * bonusValue);
