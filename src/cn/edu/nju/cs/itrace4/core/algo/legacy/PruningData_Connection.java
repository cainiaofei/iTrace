 ...
 */
public class PruningData_Connection implements CSTI {
    ...
    public PruningData_Connection(RelationInfo prunedRelationInfo, RelationInfo fullRelationInfo, UseEdge useEdge, Double bonus_threshold) {
...
//                    if (!firstPiecesCode.contains(target)) {
                        linksList.updateLink(source, target, score * (1 + vertexBonus.get(target)));
//                    }
                }
            }
