 ...
 */
public class UD_Weight_CSTI implements CSTI {

    public double bonus;
    private RelationGraph relationGraph;

    public UD_Weight_CSTI(RelationInfo relationInfo) {
...
//                ((CallDataRelationGraph) relationGraph).searhNeighbourVertexByCall(relationGraph.getCodeVertexByName(target), neighbours);
                ...
                for (CodeVertex nb : neighbours) {
                    ...
                    double extraBonus = ((CallDataRelationGraph) relationGraph).getCallEdgeBonusII(target, nb.getName());
