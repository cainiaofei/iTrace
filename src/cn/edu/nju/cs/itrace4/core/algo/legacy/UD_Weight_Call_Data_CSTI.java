...
// For callNeighbour, add extraBonusCall
    // For dataNeighbour, add extraBonusData
public class UD_Weight_Call_Data_CSTI implements CSTI {


    public double bonus;
    private RelationGraph relationGraph;

    public UD_Weight_Call_Data_CSTI(RelationInfo relationInfo) {
...
//        System.out.println(" matrix = " + matrix );
        ...
        while (originLinks.size() != 0) {
            ...
            if (oracle.isLinkAboveThreshold(source, target)) {
                List<CodeVertex> neighbours = ((CallDataRelationGraphUnormalized) relationGraph).getNeighboursByCall(target);
...
//                    System.out.println(" extraBonus = " + extraBonusCall);

                    if (originScore != -1) {
                        originLinks.updateLink(source, nb.getName(), originScore * (1 + extraBonusCall + extraBonusData));
                    }
                }
            }
...
//        System.out.println(" matrix_ud = " + matrix_ud );
    ...
    public String getAlgorithmName() {
        return "UD_Weight_Call_Data_CSTI";
    }
