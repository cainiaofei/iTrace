 ...
 */
public class PruningCall_Data_PruningO implements CSTI {


    private RelationInfo infoForRest;
    private RelationInfo brokenInfo;

    public PruningCall_Data_PruningO(RelationInfo infoForRest,RelationInfo brokenInfo) {
    ...
    public SimilarityMatrix improve(SimilarityMatrix matrix, TextDataset textDataset, SimilarityMatrix similarityMatrix) {
        SimilarityMatrix sm = (new PruningCall_Data_CSTI(brokenInfo, UseEdge.Call)).improve(matrix, textDataset, similarityMatrix);
        return (new O_Call_Data_CSTI(infoForRest)).improve(sm, textDataset, similarityMatrix);
    }
    ...
    public String getAlgorithmName() {
        return "PruningCall_Data_PruningO";
    }
