 ...
 */
public class UD_Call_III_CSTI implements CSTI {
    ...
    public UD_Call_III_CSTI(RelationInfo relationInfo, UseEdge useEdge) {
...
//                ((CallDataRelationGraph) relationGraph).searhNeighbourConnectedGraphByCall(relationGraph.getCodeVertexByName(target), connectedVertex);
                ((CallDataRelationGraph) relationGraph).searhNeighbourVertexByCall(relationGraph.getCodeVertexByName(target), connectedVertex);
