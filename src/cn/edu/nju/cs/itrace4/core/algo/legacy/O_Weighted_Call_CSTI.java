 ...
 */
public class O_Weighted_Call_CSTI implements CSTI {

    private double bonus;
    private RelationGraph relationGraph;

    public O_Weighted_Call_CSTI(RelationInfo relationInfo) {
        ...
        for (String source : matrix.sourceArtifactsIds()) {
            ...
            for (String target : links.keySet()) {
                ...
                for (CodeVertex nb : neighbours) {
                    ...
                    double extraBonus = ((CallDataRelationGraphUnormalized) relationGraph).getCallEdgeBonus(target, nb.getName());
