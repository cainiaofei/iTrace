 ...
 */
public class Pruning_O_Call_CSTI implements CSTI {

    private RelationInfo unbrokenInfo;
    private RelationInfo brokenInfo;

    public Pruning_O_Call_CSTI(RelationInfo unbrokenInfo,RelationInfo brokenInfo) {
    ...
    public SimilarityMatrix improve(SimilarityMatrix matrix, TextDataset textDataset, SimilarityMatrix similarityMatrix) {
        ...
        return (new PruningCall_CSTI(brokenInfo, UseEdge.Call)).improve(sm, textDataset, similarityMatrix);
    }
