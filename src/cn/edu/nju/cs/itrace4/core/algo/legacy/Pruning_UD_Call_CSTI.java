 ...
 */
public class Pruning_UD_Call_CSTI implements CSTI {

    private CSTI ud_csti;
    private CSTI pruning_csti;


    public Pruning_UD_Call_CSTI(RelationInfo prunedRelation, RelationInfo fullRelationFor, UseEdge call, double v) {
        pruning_csti = new PruningCall_Connection_IIII(prunedRelation, fullRelationFor, call, v);
        ud_csti = new UD_Weight_Call_CSTI(fullRelationFor);
    }
