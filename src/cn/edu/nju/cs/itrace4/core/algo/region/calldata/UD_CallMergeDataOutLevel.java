...
public class UD_CallMergeDataOutLevel implements CSTI{
	...
	public UD_CallMergeDataOutLevel(RelationInfo ri,double callThreshold,
	...
	public SimilarityMatrix improve(SimilarityMatrix matrix, TextDataset textDataset,
		...
		UD_CallMergeData improveBasedCallData = new UD_CallMergeData(
				ri,valid,percent);
...
//		return improveBasedData.improve(afterImproveBasedCall, textDataset, methodType);
	...
	public String getAlgorithmName() {
		// TODO Auto-generated method stub
		return "UD_CallMergeDataWithBonusForLone"+callThreshold+"_"+dataThreshold+"_"+methodType+"_"+percent;
	}
