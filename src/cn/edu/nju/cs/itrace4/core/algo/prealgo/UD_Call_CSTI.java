...
/**
 * Created by niejia on 15/4/9.
 */
public class UD_Call_CSTI implements CSTI{
    ...
    public UD_Call_CSTI(RelationInfo relationInfo, UseEdge useEdge) {
    ...
    public SimilarityMatrix improve(SimilarityMatrix matrix, TextDataset textDataset, SimilarityMatrix similarityMatrix) {
        ...
        Map<String, Integer> wrongSituation = new TreeMap<>();
...
//                    System.out.println(" improvedLink = " + source + " " + nb.getName() + " " + improvedScore);
                    ...
                    if (rtm.isLinkAboveThreshold(source, nb.getName())) {
                        ...
                        wrongNum++;
                        if (wrongSituation.get(nb.getName()) == null) {
                            wrongSituation.put(nb.getName(), 1);
                        } else {
                            wrongSituation.put(nb.getName(), wrongSituation.get(nb.getName()) + 1);
                        }
                        log.append("Wrong\n");
                    }
                }
...
//        System.out.println(" matrix_ud = " + matrix_ud );
        ...
        System.out.println(" wrongSituation = " + wrongSituation );
