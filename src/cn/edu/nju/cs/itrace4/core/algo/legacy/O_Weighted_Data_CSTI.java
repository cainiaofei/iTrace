 ...
 */
public class O_Weighted_Data_CSTI implements CSTI {

    private double bonus;
    private RelationGraph relationGraph;

    public O_Weighted_Data_CSTI(RelationInfo relationInfo) {
...
//                        System.out.println("Original Links: " + source + " " + child + " " + originScore);
                    matrix.setScoreForLink(source, nb.getName(), originScore * (1 + extraBonus / 30));
