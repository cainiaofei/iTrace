...
public class PruningCall_Data_Connection_II implements CSTI{
    ...
    public PruningCall_Data_Connection_II(RelationInfo prunedRelationInfo, RelationInfo fullRelationInfo, UseEdge useEdge, Double bonus_thresholdForCall, Double bonus_thresholdForData) {
...
//                            double afterBonusValue = bonus * (1.0 / (cur + 1) + extraBonus);
    ...
    public String getAlgorithmName() {
        return "PruningCall_Data_Connection_II";
    }
