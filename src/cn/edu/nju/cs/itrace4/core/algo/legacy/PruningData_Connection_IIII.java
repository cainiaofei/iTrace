 ...
 */
public class PruningData_Connection_IIII implements CSTI {
    ...
    public PruningData_Connection_IIII(RelationInfo prunedRelationInfo, RelationInfo fullRelationInfo, UseEdge useEdge, Double bonus_threshold) {
...
//            }
            ...
            double maxBonusedValue = matrix.getScoreForLink(source, maxValueTarget);
...
//            vertexBonus.clear();
    ...
    public String getAlgorithmName() {
        return "PruningData_Connection_IIII";
    }
