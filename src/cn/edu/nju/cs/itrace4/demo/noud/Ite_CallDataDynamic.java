 ...
 * @date 2017.11.08
 * @description 
 *     step1: generate call region and data region based on call/data threshold
 *     step2: merge call/data threshold
 *     step3: based on the highest IR link, give bonus for remaining about every requirement.
