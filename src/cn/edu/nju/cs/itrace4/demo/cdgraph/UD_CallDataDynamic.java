...
public class UD_CallDataDynamic implements CSTI{
	...
	public UD_CallDataDynamic(RelationInfo ri,double callThreshold,double dataThreshold,
...
//		giveBonusBasedDataGraph(matrix, subGraph, curLoneVertexList,req);
	...
	public String getAlgorithmName() {
		// TODO Auto-generated method stub
		return "UD_CallDataDynamic_"+callThreshold+"_"+dataThreshold;
	}
