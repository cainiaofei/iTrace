 ...
 */
public class SourceTargetUnion implements SourceTargetUnionInterface {
	private RemoveUCNotInRtmClass removeUC = new RemoveUCNotInRtmClass();
    public SourceTargetUnion(String ucDirPath, String srcDirPath, String rtmDBFilePath, Granularity granularity, 
...
//        bp.parse();
    ...
    public SourceTargetUnion(String ucDirPath, String srcDirPath, String rtmDBFilePath, String classDirPath, String methodDirPath) {
//        SimilarityMatrix rtm_class = SqliteIO.readRTMFromDB(rtmDBFilePath, Granularity.CLASS);
    ...
    public SourceTargetUnion(String ucDirPath, String srcDirPath, String classDirPath, String methodDirPath) {
