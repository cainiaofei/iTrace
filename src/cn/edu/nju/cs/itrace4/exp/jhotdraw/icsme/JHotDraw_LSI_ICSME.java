 ...
 */
public class JHotDraw_LSI_ICSME {
    ...
    public static void run() throws IOException, ClassNotFoundException {
        ...
        System.out.println("------------------------------");
        System.out.println("result_pruningeCall_Data_Dir JHotDraw LSI");
...
//        curve.resultStore(JHotDraw_CONSTANTS.lsiExpExportPath_ICSME, "call_0.7_data_0.9_idtf_1.4");
    }
