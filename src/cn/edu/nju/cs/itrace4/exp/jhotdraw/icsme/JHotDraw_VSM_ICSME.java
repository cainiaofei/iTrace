 ...
 */
public class JHotDraw_VSM_ICSME {
    ...
    public static void run() throws IOException, ClassNotFoundException {
        ...
        Result result_pruningeCall_Data_Dir = IR.compute(textDataset, IRModelConst.VSM, new PruningCall_Data_Connection_Closenss(class_relation, class_relationForO, class_relationForAllDependencies,UseEdge.Call, 1.0, 1.0));
...
//        result_ir.showMatrix();
        ...
        System.out.println("------------------------------");
        System.out.println("result_pruningeCall_Data_Dir JHotDraw VSM");
...
//        result_pruningeCall_Data_Dir.showMatrix();
...
//        VisualCurveFmeasure curveFmeasure = new VisualCurveFmeasure();
//        curveFmeasure.addLine(result_ir);
////        curve.addLine(result_pagerank);
//        curveFmeasure.addLine(result_pruningeCall_Data_Dir);
//        curveFmeasure.showChart();
