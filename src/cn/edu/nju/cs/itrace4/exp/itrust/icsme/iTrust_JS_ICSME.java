...
public class iTrust_JS_ICSME {
    ...
    public static void run() throws IOException, ClassNotFoundException {
        ...
        System.out.println("------------------------------");
        System.out.println("result_pruningeCall_Data_Dir iTrust_JSD");
        ...
        curve.showChart();
//        curve.resultStore(ITRUST_CONSTANTS.jsExpExportPath_ICSME, "call_0.7_data_0.9_idtf_1.4");
    }
